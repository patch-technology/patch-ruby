...
# Unit tests for Patch::UpdateProjectRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Patch::UpdateProjectRequest do
  let(:instance) { Patch::UpdateProjectRequest.new }

  describe 'test an instance of UpdateProjectRequest' do
    it 'should create an instance of UpdateProjectRequest' do
      expect(instance).to be_instance_of(Patch::UpdateProjectRequest)
    end
  end
